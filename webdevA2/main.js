...
function S2_GM_DIET() {
        ...
        function S2_GM_END_Condition() {
            if (GM_lives <= 0) {
                ...
                if (CWidth < 800) {
                    ...
                    S2_GM_exit.classList.remove("S2_GM_H1", "S2_GM_Font5vw"); S2_GM_exit.classList.add("S2_GM_Font7vw");
                }
                else {
    ...
    function S2_GM_RESET() {
        ...
        S2_GM_exit.classList.remove("S2_GM_H2", "S2_GM_Font7vw", "S2_GM_H1", "S2_GM_Font5vw");
    ...
    function S2_GM_STOP() {
        ...
        S2_GMBTN_HOLDER[2].classList.add("display_out"); S2_GMBTN_HOLDER[2].classList.remove("S2_GM_H2", "S2_GM_H3", "S2_GM_H4"); 
        S2_GM_exit.classList.remove("S2_GM_H2", "S2_GM_Font7vw", "S2_GM_H1", "S2_GM_Font5vw", "S2_GM_Font1_9vw");
